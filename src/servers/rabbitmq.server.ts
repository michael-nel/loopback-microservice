...
import {AmqpConnectionManagerOptions, AmqpConnectionManager, ChannelWrapper, connect} from 'amqp-connection-manager';
...
export class RabbitmqServer extends Context implements Server {
    ...
    async start(): Promise<void> {
        this._conn = await connect([this.config.uri], this.config.connOptions);
